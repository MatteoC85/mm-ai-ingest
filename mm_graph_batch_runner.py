...
RUNNER_VERSION = "mm-graph-batch-runner-v3.2"
EXPECTED_PIPELINE_MARKER = (
    "phase2-graph-v3.2-anonymous-graphic-identity-source-snapshot"
)
EXPECTED_MATERIALIZER_VERSION = "mm-electrical-graph-materializer-v3.2"
DEFAULT_BASE_URL = (
